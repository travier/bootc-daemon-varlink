...
pub trait Call_Status: VarlinkCallError {
    fn reply(&mut self, r#status: String) -> varlink::Result<()> {
        self.reply_struct(Status_Reply { r#status }.into())
    }
}
impl<'a> Call_Status for varlink::Call<'a> {}
...
impl varlink::Interface for VarlinkInterfaceProxy {
    ...
    fn call(&self, call: &mut varlink::Call) -> varlink::Result<()> {
        ...
        match req.method.as_ref() {
            "org.bootc.Status" => self.inner.status(call as &mut dyn Call_Status),
